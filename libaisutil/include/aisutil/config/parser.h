...
# define LIBAISUTIL_CONFIG_CLASS_HANDLER(x) \
     bool x(AIS::Util::String& errString, \
	    const AIS::Util::String& defName, \
            const AIS::Util::ConfigParser::defValues_type& values, \
	    AIS::Util::ConfigData& dataClass, \
	    const void* dataVariable, \
	    AIS::Util::String& configData, \
	    AIS::Util::String::size_type& position)
